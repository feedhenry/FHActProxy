...
Ext.ux.FHActProxy = Ext.extend(Ext.data.Proxy, {
    ...
    constructor: function() {
        ...
        if (this.id == undefined) {
            throw "No unique id was provided to the FH storage proxy.";
        }
    ...
    create: function(operation, callback, scope) {
        ...
        var rawData = [];
        //save records from operation or records from the previous action
    ...
    createRequestCallback: function(operation, callback, scope, syncCallback) {
        ...
        return function(response){
          ...
          if (response && response!=null){
              ...
              operation.addRecords = false; // misleading - this is the 'append' property of a store. Don't append - blind replace!
